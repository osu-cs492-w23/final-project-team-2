...
public class MovieListJsonAdapter(
  ...
  public override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("MovieList").append(')') }

  public override fun fromJson(reader: JsonReader): MovieList {
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        1 -> overview = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull("overview",
            "overview", reader)
        2 -> poster_path = stringAdapter.fromJson(reader) ?:
  ...
  public override fun toJson(writer: JsonWriter, value_: MovieList?): Unit {
    if (value_ == null) {
